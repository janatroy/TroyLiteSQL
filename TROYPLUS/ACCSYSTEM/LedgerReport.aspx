    ...
    <form id="form1" method="post" runat="server">
        ...
        <div align="center" id="div1" runat="server">
            <table cellpadding="1" cellspacing="2" width="450px" border="0" style="border: 1px solid blue; background-color: White; text-align: left">
                <tr>
                    <td class="headerPopUp" colspan="4">Ledger Report
                    </td>
                </tr>
                <tr style="height: 6px">
                </tr>
                    ...
                    <td colspan="4">
                        <table>
                            <tr>
                                ...
                                <td class="ControlTextBox3" style="width: 35%">
                            ...
                            <tr>
                                ...
                                <td class="ControlTextBox3" style="width: 35%">
                                    <asp:TextBox ID="txtEndDate" runat="server" CssClass="cssTextBox" MaxLength="10" />
                                </td>
                                <td style="width: 10%">
                                    <script type="text/javascript" language="JavaScript">
                            ...
                            <tr>
                                <td style="width: 35%; font-family: 'ARIAL'; font-size: 11px; font-weight: normal; color: #000000; text-align: right; text-decoration: none; padding-right: 5px; padding-left: 5px; padding-top: 5px;" height="27px">Heading
                                </td>
                                <td align="left" class="ControlDrpBorder" style="width: 35%">
                            ...
                            <tr>
                                <td style="width: 35%; font-family: 'ARIAL'; font-size: 11px; font-weight: normal; color: #000000; text-align: right; text-decoration: none; padding-right: 5px; padding-left: 5px; padding-top: 5px;" height="27px">Display Order
                    <br />
                                    (For Date)
                                </td>
                                <td align="left" class="ControlDrpBorder" style="width: 15%">
        ...
        <table width="600px">
            ...
            <div id="divPrint" style="font-family: 'Trebuchet MS'; font-size: 11px;" align="center">
               ...
               <asp:TemplateField >
                ...
                <table width="600px" border="0" cellspacing="0" cellpadding="1" style="font-family: 'Trebuchet MS'; font-size: 11px;">
                    <tr>
