<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockSummaryReport.aspx.cs"
    Inherits="StockSummaryReport" %>
        ...
        <table cellpadding="0" cellspacing="1" border="0" style="border: 1px solid Blue; background-color:White;
            ...
            <tr>
                ...
                <td align="left"  style="width:30%" class="ControlDrpBorder">
                    <asp:DropDownList TabIndex="1" ID="cmbDisplayCat" Width="100%"  CssClass="drpDownListMedium" BackColor = "#90c9fc"
                        ...
                        <asp:ListItem Text="Categorywise" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Brandwise" Value="2"></asp:ListItem>
                        <asp:ListItem Text="Modelwise" Value="3"></asp:ListItem>
                        <asp:ListItem Text="Itemwise" Value="4"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td align="left" style="width:15%">
            ...
            <tr>
                ...
                <td align="left" style="width:30%">
                    <asp:RadioButton GroupName="1" ID="chkPurReturn" name="1" runat="server" Visible="False" />

                    <br />
                    <asp:RadioButton ID="chkIntTrans" GroupName="1" runat="server" Visible="False" />

                    <br />
                    <asp:RadioButton ID="chkDelNote" GroupName="1" runat="server" Visible="False" />
