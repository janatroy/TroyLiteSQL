<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReportExcelProductsHistory.aspx.cs" Inherits="ReportExcelProductsHistory" Title="Products History Page" %>
            ...
            <table width="100%" style="background-color:White; border:1px solid blue;">
                ...
                <tr>
                    ...
                    <td style="width: 30%;" class="ControlDrpBorder">
                            ...
                            <asp:ListItem Value="0" style="background-color: #90c9fc">All</asp:ListItem>
                            </asp:DropDownList>
                    </td>
                    <td style="width: 25%;">
                ...
                <tr>
                    ...
                    <td style="width: 30%;" class="ControlDrpBorder">
                            <asp:DropDownList ID="ddlproduct" runat="server" Width="100%"  style="border: 1px solid #90c9fc" height="26px" AutoPostBack="true"
                            CssClass="drpDownListMedium" BackColor = "#90C9FC" OnSelectedIndexChanged="ddlproduct_SelectedIndexChanged">
                            <asp:ListItem Selected="True" Value="All" style="background-color: #90c9fc">All</asp:ListItem>
                            </asp:DropDownList>
                    </td>
                    <td style="width: 25%;">
                ...
                <tr>
                    ...
                    <td class="ControlDrpBorder" style="width: 30%">
                        <asp:DropDownList ID="cmbProdAdd" runat="server" AppendDataBoundItems="true" BackColor = "#90c9fc"
                            DataTextField="ItemCode" DataValueField="ItemCode"  style="border: 1px solid #90c9fc" height="26px" CssClass="drpDownListMedium"
                            ValidationGroup="product" Width="100%">
                            <asp:ListItem style="background-color: #90c9fc;" Value="All">All</asp:ListItem>
                        </asp:DropDownList>
                    </td>
