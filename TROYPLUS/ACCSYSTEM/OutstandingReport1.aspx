<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutstandingReport1.aspx.cs"
    Inherits="OutstandingReport1" %>
            ...
            <table cellpadding="1" cellspacing="2" border="0" style="border: 1px solid blue; background-color: White; text-align: left; width: 450px">
                ...
                <tr>
                    ...
                    <td class="ControlTextBox3" style="width: 24%;">
                        <asp:TextBox ID="txtStartDate" runat="server" AutoPostBack="True" BackColor="#e7e7e7" CssClass="cssTextBox" Height="23px" MaxLength="10" TabIndex="1" ValidationGroup="salesval"></asp:TextBox>
            ...
            <div id="divPrint" style="font-family: 'Trebuchet MS'; font-size: 11px;">
                ...
                <wc:ReportGridView runat="server" BorderWidth="1" ID="gvLedger" CssClass="gridview"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField ItemStyle-HorizontalAlign="center" DataField="BranchCode" HeaderText="BranchCode" />
