<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportExlSales.aspx.cs"
    Inherits="ReportExlSales" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function pageLoad() {
            ...
            var tabContainer = $find('ctl00_cplhControlPanel_tabEdit_tabEditMain');
                ...
                <td colspan="3" style="width:100%">
                    ...
                    <td align="left" width="35%"></td>
                                    ...
                                    <tr>
                                        ...
                                        <asp:Button ID="btnreportbasic"  EnableTheming="false" runat="server" CssClass="NewReport6"
                                            Width="120px" OnClick="btnreportbasic_Click" />
                          ...
                          <cc1:TabPanel ID="tabEditAddTab" runat="server" HeaderText="Advance">
                               <ContentTemplate>   
                                   <table cellpadding="1" cellspacing="1" style="width:760px">
                                        <tr style="height:10px">
                                        </tr>
                                        <tr>
                                            <td style="width:9%; font-family:'ARIAL';font-size:11px;font-weight:normal; color: #000000;text-align:right;text-decoration:none;padding-right:5px;padding-left:5px;padding-top:5px;" height="27px">
                                                Start Date
                                            ...
                                            <td style="width:7%; font-family:'ARIAL';font-size:11px;font-weight:normal; color: #000000;text-align:right;text-decoration:none;padding-right:5px;padding-left:5px;padding-top:5px;" height="27px">
                                                End Date
                                            ...
                                            <td style="width: 25%;">
                                                <asp:ImageButton ID="ImageButton3" runat="server" CausesValidation="False" 
                                                                                                    ImageUrl="App_Themes/NewTheme/images/cal.gif" 
                                                                                                    Width="20px" />
                                                <asp:CheckBox ID="withsalreturn" runat="server" Text="With Sales Return" />
                                            </td>
                                        </tr>
                                        <tr style="height:1px">
                                       </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 62%;"  class="ControlTextBox3">
                                                            <asp:RadioButtonList ID="opttype" runat="server"
                                                                            ...
                                                                            <asp:ListItem Text="Sales" Selected="True"></asp:ListItem>
                                                        ...
                                                        <td style="width: 26%;" align="left" class="ControlTextBox3">
                                            ...
                                            <td colspan="4">
                                              <table cellpadding="1" cellspacing="1" style="width:100%">
                                                  <tr>
                                                        ...
                                                        <td style="width: 70%;"  class="ControlTextBox3">
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td class="ControlTextBox3" style="width: 40%;">
                                                          <asp:RadioButtonList ID="opt" runat="server"
                                                              ...
                                                              <asp:ListItem Text="Executive Wise"></asp:ListItem>
                                                              <asp:ListItem Text="Date Wise"></asp:ListItem>
                                                              <asp:ListItem Text="Month Wise"></asp:ListItem>
                                                              <asp:ListItem Text="Customer Wise"></asp:ListItem>
                                                          </asp:RadioButtonList>
                                                      </td>
                                                      ...
                                                      <td class="ControlTextBox3" style="width: 16%;">
                                                          ...
                                                          <asp:CheckBox ID="chkgpdp" runat="server" Text="GP for DP" />
                                                      </td>
