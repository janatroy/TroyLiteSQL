<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BulkProductUpdation.aspx.cs" Inherits="BulkProductUpdation" %>
                        ...
                        <tr>
                            ...
                            <td style="width:35%" align="left" class="ControlTextBox3">
                                <asp:RadioButtonList ID="chkPayTo" runat="server" Width="100%">
                                    <asp:ListItem Text="Only MRP" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Only NLC" Value="2"></asp:ListItem>
                                    <asp:ListItem Text="Only DP" Value="3"></asp:ListItem>
                                    <asp:ListItem Text="MRP And DP" Value="5"></asp:ListItem>
                                    <asp:ListItem Text="NLC And DP" Value="6"></asp:ListItem>
                                    <asp:ListItem Text="MRP And NLC" Value="7"></asp:ListItem>
                                    <asp:ListItem Text="Only Stock Level" Value="9"></asp:ListItem>
                                    <asp:ListItem Text="Only Deviation %" Value="10"></asp:ListItem>
                                    <asp:ListItem Text="Only OutDated" Value="11"></asp:ListItem>
                                    <%--<asp:ListItem Text="Only Min Sale %" Value="8"></asp:ListItem>--%>
