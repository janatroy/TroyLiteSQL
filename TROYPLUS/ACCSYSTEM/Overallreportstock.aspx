<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Overallreportstock.aspx.cs" Inherits="Overallreportstock" %>
...
<head runat="server">
    ...
    <title>Stock Transaction summary Report</title>
        ...
        <div style="text-align: center; min-height: 400px">
            ...
            <div align="center" id="div1" runat="server">
                ...
                <td colspan="4">
                    ...
                    <tr>
                        <td colspan="4" class="headerPopUp">Stock Transaction summary Report
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <table style="width: 100%">
                                <tr>
                                    <td runat="server" visible="false" style="width: 35%; font-family: 'ARIAL'; font-size: 11px; font-weight: normal; color: #000000; text-align: right; text-decoration: none; padding-right: 5px; padding-left: 5px; padding-top: 5px;" height="27px">Date
                                    </td>
                                    <td style="width: 25%" align="left" visible="false" class="ControlTextBox3">
                                        <asp:TextBox ID="txtStartDate" Visible="false" Enabled="true" runat="server" CssClass="cssTextBox" Width="100px"
                                            MaxLength="10" />

                                    </td>
                                    <td style="width: 35%" runat="server" visible="false" align="left">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="overflow-y: scroll; height: 150px; width: 250px" runat="server">
                                            ...
                                            <asp:RadioButtonList ID="lstBranch" runat="server"  AppendDataBoundItems="true" DataTextField="BranchName" DataValueField="Branchcode" >
                                                <asp:ListItem Text="All" Value="0" />
                                            </asp:RadioButtonList>
                                        </div>
                                    </td>
                                    <td runat="server" visible="false">
                                        <div style="overflow-y: scroll; height: 150px; visibility:hidden; width: 250px">
                                            <asp:Label ID="Label1" CssClass="ControlLabelproject" runat="server" Text="Select Pricelist:"></asp:Label>

                                            <asp:RadioButtonList ID="lstPricelist" AutoPostBack="true" runat="server"  AppendDataBoundItems="true" DataTextField="PriceName" DataValueField="PriceName">
                                                <%--  <asp:ListItem Text="All" Value="0" />--%>
                                            </asp:RadioButtonList>
                                        </div>
                                    </td>
                        ...
                        <td colspan="4">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td runat="server"  style="width: 19%">
