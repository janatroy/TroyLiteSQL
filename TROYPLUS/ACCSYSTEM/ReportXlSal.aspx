<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportXlSal.aspx.cs"
    Inherits="ReportXlSal" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div align="center">
            <br />
            <table cellpadding="2" cellspacing="2" width="400px" border="0" style="border: 1px solid Blue; text-align: left">
                <tr>
                    <td colspan="3" class="headerPopUp">Sales Turnover Report
                    </td>
                </tr>
                                ...
                                <ContentTemplate>
                                    ...
                                    <td class="ControlDrpBorder" style="width: 25%;">
                                        <asp:DropDownList TabIndex="1" ID="drpCustomer" AppendDataBoundItems="true"
                                            ...
                                            <td class="ControlLabel2" style="width: 20%;">Start Date
                                    ...
                                    <td class="ControlDrpBorder" style="width: 25%;">
                                        <asp:DropDownList ID="drpFrequency" TabIndex="4" AppendDataBoundItems="True" CssClass="drpDownListMedium" BackColor = "#90c9fc"
                                            ...
                                            <td class="ControlLabel2" style="width: 20%;">End Date
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td class="ControlTextBox3" style="width: 100%;">
                                                    <asp:RadioButtonList ID="optionrate" runat="server" CssClass="label" 
                                                    RepeatDirection="Horizontal" BackColor="#90C9FC" Height="25px">
                                                            <asp:ListItem Selected="True">Monthly Head Wise</asp:ListItem>
