...
public partial class ReportExlPurchase : System.Web.UI.Page
{
    ...
    public void bindDataCategoryWiseNormal()
    {
        ...
        if (ds != null)
        {
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    if (fLvlValue != "" && fLvlValue != fLvlValueTemp)
                    {
                        ...
                        if (chkboxAvg.Checked == true)
                            dr_final8["Avg"] = Convert.ToString(Convert.ToDouble(CategoryTotal) / Convert.ToDouble(qtyTotal));
                    ...
                    if (chkboxAvg.Checked == true)
                        dr_final12["Avg"] = Convert.ToString(Convert.ToDouble(dr["amount"]) / Convert.ToDouble(dr["Qty"]));
            ...
            if (chkboxAvg.Checked == true)
                dr_final897["Avg"] = Convert.ToString(Convert.ToDouble(CategoryTotal) / Convert.ToDouble(qtyTotal));
            ...
            if (chkboxAvg.Checked == true)
                dr_final789["Avg"] = Convert.ToString(Convert.ToDouble(total) / Convert.ToDouble(CategoryqtyTotal));
        ...
        if (ds != null)
        {
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    if (chkboxAvg.Checked == true)
                        dr_final12["Avg"] = Convert.ToString(Convert.ToDouble(total) / Convert.ToDouble(CategoryQtyTotal));
        ...
        if (ds != null)
        {
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    if (chkboxAvg.Checked == true)
                        dr_final12["Avg"] = Convert.ToString(Convert.ToDouble(dr["rate"]) / Convert.ToDouble(dr["Qty"]));
    ...
    protected void Btnexl_Click(object sender, EventArgs e)
    {
        ...
        if (optoption.SelectedItem.Text == "Old")
        {
            ...
            else if (opt.SelectedItem.Text == "SupplierWise")
            {
