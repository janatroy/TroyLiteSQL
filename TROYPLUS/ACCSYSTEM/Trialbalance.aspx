<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Trialbalance.aspx.cs" Inherits="Trialbalance"
            ...
            <table cellpadding="1" cellspacing="2" width="450px" border="0" style="border: 1px solid blue; background-color:White;">
                ...
                <tr>
                    ...
                    <td width="25%" class="ControlTextBox3">
                        <asp:TextBox ID="txtStartDate" Enabled="false" runat="server" CssClass="cssTextBox"
                            MaxLength="10" />
                    </td>
                    <td width="10%">
                ...
                <tr>
                    ...
                    <td  width="25%" class="ControlTextBox3">
                        <asp:TextBox ID="txtEndDate" Enabled="false" CssClass="cssTextBox" runat="server" MaxLength="10" />
                    </td>
                    <td width="10%">
                        <script type="text/javascript" language="JavaScript">
