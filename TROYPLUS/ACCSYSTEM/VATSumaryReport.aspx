<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VATSumaryReport.aspx.cs"
    Inherits="VATSumaryReport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div align="center">
            <table cellpadding="2" cellspacing="1" width="450px" border="0" style="border: 1px solid blue; background-color: White;">
                <tr>
                    <td colspan="4" class="headerPopUp">VAT Summary Report
                    </td>
                </tr>
            ...
            <div id="divPrint">
                <div id="dvVat" style="font-family: 'Trebuchet MS'; font-size: 11px;" runat="Server">
                    <table style="border: 1px solid black; font-size: 11px; background-color: Aliceblue"
                        ...
                        <tr>
                            <td colspan="3" height="2%" class="subHeadFont2">VAT Summary
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="2" width="70%" style="border-right: 1px solid black;" align="left">&nbsp;&nbsp;<b>Particulars</b>
                            </td>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="15%" align="right">
                                            <asp:Label ID="lblActualSales" runat="server" Style="font-family: 'Trebuchet MS'; font-size: 11px;"></asp:Label>
                                        </td>
                                        <td width="15%" align="right">
                            ...
                            <td colspan="3">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="15%" align="right">
                                            <asp:Label ID="lblActualPurchase" runat="server" Style="font-family: 'Trebuchet MS'; font-size: 11px;"></asp:Label>
                                        </td>
                                        <td width="15%" align="right">
                                            <asp:Label ID="lblVatPurchase" runat="server" Style="font-family: 'Trebuchet MS'; font-size: 11px;"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid black;" align="right">
                                <asp:Label ID="lblVatPayable" runat="server" Style="font-family: 'Trebuchet MS'; font-size: 11px;"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <br />
