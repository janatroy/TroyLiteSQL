                ...
                <tr style="width: 100%">
                    <td style="width: 100%">
                        ...
                        <div class="mainConBody">
                            <table style="width: 99.8%; margin: -1px 0px 0px 1px;" cellpadding="3" cellspacing="2" class="searchbg">
                                <tr style="vertical-align: middle">
                                    ...
                                    <td style="width: 52%; font-size: 22px; color: white;">Specification of Products
                                    </td>
                                    <td style="width: 13%">
                                        <div style="text-align: right;">
                                        </div>
                                    </td>
                                    <td style="width: 7%; color: white;" align="right">Search
                                    </td>
                        ...
                        <div style="width: 100%; text-align: left">
                            ...
                            <asp:Panel runat="server" ID="popUp" Style="width: 85%; background-color: White; display: none">
                                        ...
                                        <div>
                                            <div id="contentPopUp">
                                                <table style="border: 1px solid #5078B3; height: 250px;" width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="4">
                                                            <table style="border: 0px solid #5078B3; background-color: #fff; color: #000;">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Panel ID="prodPanel" runat="server" Visible="False">
                                                                            <table width="1100px" style="border: 0px solid #5078B3; background-color: #fff; color: #000;">
                                                                                <tr style="height: 5px">
                                                                                </tr>
                                                                                <tr style="height: 5px">
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="ControlLabelproject1" style="width: 28%">Name of Product to be Manufactured
                                                                                    </td>
                                                                                    <td style="width: 2%"></td>
                                                                                    ...
                                                                                    <td class="ControlLabelproject" style="width: 20%;">Select Branch                                                                                       
                                                                                    </td>
                                                                        ...
                                                                        <asp:Panel ID="salesPanel" runat="server" Visible="False">
                                                                            <table width="100%" cellpadding="1" style="font-size: 12px; font-weight: bold;">
                                                                                <tr runat="server" style="height: 30px;">
                                                                                    <td style="font-size: 14px; width: 14%; background: #cccccc; font-weight: bold; border: 1px solid Gray;">Component ID
                                                                                    </td>
                                                                                    <td style="font-size: 14px; width: 15%; background: #cccccc; font-weight: bold; border: 1px solid Gray;">Component Name
                                                                                    </td>
                                                                                    <td style="font-size: 14px; width: 31%; background: #cccccc; font-weight: bold; border: 1px solid Gray;">Description
                                                                                    </td>
                                                                                    <td style="font-size: 14px; width: 5%; background: #cccccc; font-weight: bold; border: 1px solid Gray;">Qty.
                                                                                    </td>
                                                                                    <td style="font-size: 14px; width: 12%; background: #cccccc; font-weight: bold; border: 1px solid Gray;">Type of Component
                                                                                    </td>
                                                                                    <td style="font-size: 14px; width: 16%; background: #cccccc; font-weight: bold; border: 1px solid Gray;">Unit of Measure
                                                                                    </td>
                                                                                ...
                                                                                <tr valign="middle">
                                                                                    <td class="ControlDrpBorder" style="width: 14%;">
                                                                                        <div style="font-family: 'Trebuchet MS';">
                                                                                            <asp:UpdatePanel ID="updname" runat="server" UpdateMode="Conditional">
                                                                                                <ContentTemplate>
                                                                                    ...
                                                                                    <td valign="top" class="ControlTextBoxmanu" style="width: 15%;">
                                                                                        <asp:UpdatePanel ID="Updpname" runat="server" UpdateMode="Conditional">
                                                                                            <ContentTemplate>
                                                                                    ...
                                                                                    <td valign="top" class="ControlTextBoxmanu" style="width: 13%;">
                                                                                        <asp:UpdatePanel ID="Updpdesc" runat="server" UpdateMode="Conditional">
                                                                                            <ContentTemplate>
                                            ...
                                            <div style="margin: -2px 0px 0px 0px;">
                                                <asp:GridView ID="GridViewFormula" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="BranchCode" HeaderText="Branch Code" ItemStyle-HorizontalAlign="Left" HeaderStyle-BorderColor="Gray" />
