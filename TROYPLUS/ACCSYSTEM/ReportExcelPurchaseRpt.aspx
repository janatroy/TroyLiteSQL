<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReportExcelPurchaseRpt.aspx.cs" Inherits="PurchaseRpt" Title="PurchaseRpt Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <center>
        <table>
            ...
            <tr>
                ...
                <td colspan="4" align="center">
                    <strong>
                        <asp:Label ID="Label8" runat="server" Text="Purchase Report" CssClass="td"></asp:Label></strong>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <asp:GridView ID="GridPur" runat="server" BackColor="White" BorderColor="White" BorderStyle="Ridge"
