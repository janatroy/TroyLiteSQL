<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LedgerMultipleReport.aspx.cs" Inherits="LedgerMultipleReport" %>
...
<body style="font-family: 'Trebuchet MS'; font-size: 11px;">
    ...
    <div align="center">
        ...
        <table cellpadding="1" cellspacing="2" width="700px" border="0" style="border: 1px solid Blue; background-color:White;
            text-align: left">
            <tr>
                <td class="subHeadFont2" colspan="6">
                    Ledger Report (Multiple Selection)
                </td>
            </tr>
            <tr style="height:3px">
            ...
            <tr>
                <td colspan="6">
                    <table width="100%">
                        <tr>
                            <td  style="width:14%; font-family:'ARIAL';font-size:11px;font-weight:normal; color: #000000;text-align:right;text-decoration:none;padding-right:5px;padding-left:5px;padding-top:5px;" height="27px">
                                Ledger Name
                            </td>
                            <td align="left" class="ControlDrpBorder" style="width:77%">
                                ...
                                <asp:ListBox ID="list1" runat="server" DataValueField="LedgerID" SelectionMode="Multiple" Width="100%"  BackColor = "#90c9fc" style="border: 1px solid #90c9fc" height="150px" CssClass="drpDownListMedium" AppendDataBoundItems="true" AutoPostBack="true" DataTextField="LedgerName">
                                    <asp:ListItem Text=" -- All -- " Value="0"></asp:ListItem>
                                </asp:ListBox>
                            </td>
                            <td style="width:15%">
    ...
    <div id="LedgerPanel" runat="server" visible="false">
        &nbsp;
        <br />
        <br />
