<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportXlTotalSales.aspx.cs"
    Inherits="ReportXlTotalSales" %>
                            ...
                            <table cellpadding="3" cellspacing="1" width="400px">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <table width="100%">
                                            <tr>
                                                <td class="ControlLabel2" style="width: 5%;">
                                                    Option
                                                </td>
                                                <td class="ControlTextBox3" style="width: 90%;">
                                                    <asp:RadioButtonList ID="optionrate" runat="server" CssClass="label" 
                                                            ...
                                                            <asp:ListItem Selected="True">Branch Wise</asp:ListItem>
                                    ...
                                    <td colspan="4">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td align="center" style="width: 32%;">
                                                <asp:Button ID="btnExcel" runat="server" OnClick="btnExcel_Click" CssClass="generatebutton"
                                                    EnableTheming="false" />
                                                </td>
                                                <td>
                                                </td>
