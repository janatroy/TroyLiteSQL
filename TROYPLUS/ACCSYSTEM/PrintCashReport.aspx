<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintCashReport.aspx.cs"
    Inherits="PrintCashReport" %>

<%@ Register Assembly="Shared.WebControls" Namespace="Shared.WebControls" TagPrefix="wc" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Print Preview - Cash Statement Report</title>
    ...
    <div>
        ...
        <div id="divPrint" style="font-family: 'Trebuchet MS'; font-size: 11px;">
            ...
            <wc:ReportGridView runat="server" BorderWidth="1" ID="gvCash" CssClass="gridview"
                ...
                font-size: 11px;" OnRowDataBound="gvCash_RowDataBound">
                <PageHeaderTemplate>
                    <br />
                    <br />
                </PageHeaderTemplate>
