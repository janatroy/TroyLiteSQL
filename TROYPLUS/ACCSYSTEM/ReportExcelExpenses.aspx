<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReportExcelExpenses.aspx.cs" Inherits="ReportExcelExpenses" Title="Expenses Page" %>
                    ...
                    <td colspan="4">
                        <table style="width:100%">
                            <tr>
                                ...
                                <td  style="width:40%">
                                    <asp:Label ID="Label7" runat="server" Text="Expenses Details" Font-Bold="True" Font-Size="13" ForeColor="#0033CC"></asp:Label>
                                </td>
                                <td style="width:30%">
