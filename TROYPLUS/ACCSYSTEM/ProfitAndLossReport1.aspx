        ...
        <div align="center">
            ...
            <div id="div1" runat="server">
                <table cellpadding="1" cellspacing="2" width="450px" border="0" style="border: 1px solid blue; background-color: White; text-align: left">
                    ...
                    <tr>
                        <td style="width: 30%; font-family: 'ARIAL'; font-size: 11px; font-weight: normal; color: #000000; text-align: right; text-decoration: none; padding-right: 5px; padding-left: 5px; padding-top: 5px;" height="27px">Start Date
                        </td>
                    ...
                    <tr>
                        <td style="width: 30%; font-family: 'ARIAL'; font-size: 11px; font-weight: normal; color: #000000; text-align: right; text-decoration: none; padding-right: 5px; padding-left: 5px; padding-top: 5px;" height="27px">End Date
                        </td>
                        <td class="ControlTextBox3" width="25%">
                        ...
                        <tr>
                            <td style="border-right: 1px solid black;">
                                <table cellpadding="2" cellspacing="4" border="0" style="font-weight: bold;" class="lblFont">
                                    <tr>
                                        <td align="left">&nbsp;Opening Stock
                                        </td>
                                        <td align="right">&nbsp;<asp:Label ID="lblOpeningStock" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">&nbsp;Purchase A/c
                                        </td>
                                        <td align="right">&nbsp;<asp:Label ID="lblPurchaseTotal" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">&nbsp;Purchase Return
                                        </td>
                                        <td align="right">&nbsp;<asp:Label ID="lblPurchaseReturnTotal" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">&nbsp;
                                        </td>
                                        <td align="right" style="border-top: 1px solid black; border-bottom: 1px solid black;">&nbsp;<asp:Label ID="lblFirstMidTotal" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">&nbsp;
                                    <img onclick="javascript:switchViews('dvDX','imgDX');" id="imgDX" runat="server"
                                        ...
                                        <td align="right">&nbsp;<asp:Label ID="lblDXTotal" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left">&nbsp;Gross Profit
                                        </td>
                                        <td align="right" style="border-top: 1px solid black; border-bottom: 1px solid black;">&nbsp;<asp:Label ID="lblGP" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td>
                                <table cellpadding="2" cellspacing="4" width="70%" border="0" style="font-weight: bold;"
                                    class="lblFont">
                                    <tr>
                                        <td align="left">&nbsp;Closing Stock
                                        </td>
                                        <td align="right">&nbsp;<asp:Label ID="lblClosingStock" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">&nbsp;Sales A/c
                                        </td>
                                        <td align="right">&nbsp;<asp:Label ID="lblSalesTotal" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">&nbsp;Sales Return
                                        </td>
                                        <td align="right">&nbsp;<asp:Label ID="lblSalesReturnTotal" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">&nbsp;
                                        </td>
                                        <td align="right" style="border-top: 1px solid black; border-bottom: 1px solid black;">&nbsp;<asp:Label ID="lblSecondMidTotal" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">&nbsp;
                                    <img onclick="javascript:switchViews('dvDI','imgDI');" id="imgDI" runat="server"
                                        ...
                                        <td align="right">&nbsp;<asp:Label ID="lblDIncome" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" align="left">
                                    ...
                                    <tr>
                                        <td align="left">&nbsp;Gross Loss
                                        </td>
                                        <td align="right" style="border-top: 1px solid black; border-bottom: 1px solid black;">&nbsp;<asp:Label ID="lblGL" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td style="border-right: 1px solid black;">
                                <table cellpadding="2" cellspacing="4" width="70%" border="0" style="font-weight: bold;"
                                    ...
                                    <img onclick="javascript:switchViews('dvIDX','imgIDX');" id="imgIDX" runat="server"
                                        ...
                                        <td align="right">&nbsp;<asp:Label ID="lblIDXExptotal" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" align="left">
                                    ...
                                    <tr>
                                        <td align="left">&nbsp;Net Profit
                                        </td>
                                        <td align="right" style="border-top: 1px solid black; border-bottom: 1px solid black;">&nbsp;<asp:Label ID="lblNetProfit" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td>
                                <table cellpadding="2" cellspacing="4" width="70%" border="0" style="font-weight: bold;"
                                    ...
                                    <img onclick="javascript:switchViews('dvIDI','imgIDI');" id="imgIDI" runat="server"
                                        ...
                                        <td align="right">&nbsp;<asp:Label ID="lblIDIncome" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" align="left">
                                    ...
                                    <tr>
                                        <td align="left">&nbsp;Net Loss
                                        </td>
                                        <td align="right" style="border-top: 1px solid black; border-bottom: 1px solid black;">&nbsp;<asp:Label ID="lblNetLoss" Text="0" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
