<%@ Page Language="C#" MasterPageFile="~/PageMaster.master" AutoEventWireup="true"
    CodeFile="CustomerReceipt.aspx.cs" Inherits="CustomerReceipt" Title="Customer Receipt" %>
                        ...
                        <asp:Panel runat="server" ID="popUp" Style="width: 60%">
                            <div id="contentPopUp">
                                <table class="tblLeft" cellpadding="0" cellspacing="0" style="border: 0px solid #5078B3;
                                    background-color: #fff; color: #000;" width="800px">
                                    <tr>
                                        <td>
                                            <asp:FormView ID="frmViewAdd" runat="server" Width="100%" DataSourceID="frmSource"
                                                                                ...
                                                                                <table style="width: 100%; vertical-align: text-top" align="center" cellpadding="3"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="ControlTextBox">
                                                                                            <asp:TextBox ID="txtBillNo" runat="server" Text='<%# Bind("BillNo") %>' Width="100%"
                                                                                        ...
                                                                                        <td class="ControlTextBox">
                                                                                            <asp:TextBox ID="txtBillAmount" runat="server" Text='<%# Bind("BillAmount") %>' Width="100%"
                                                                                                SkinID="skinTxtBoxGrid"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="ControlTextBox">
                                                                                            <asp:DropDownList ID="ComboBox2" runat="server" SkinID="skinDdlBox" AutoPostBack="True" Height="29px" CssClass="drpDownListMedium" BackColor = "#90c9fc"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <asp:DropDownList ID="ddBanks" Enabled="true" runat="server" OnDataBound="ddBanks_DataBound"
                                                                                                                ...
                                                                                                                <asp:ListItem Selected="True" style="background-color: #bce1fe" Value="0">-- Please Select --</asp:ListItem>
                                                                                                            </asp:DropDownList>
                                                                                                        </td>
                                                                                                        <td class="ControlLabel">
                                                                                                            Cheque No. *
                                                ...
                                                <InsertItemTemplate>
                                                    <div class="divArea">
                                                        <table class="tblLeft" cellpadding="0" cellspacing="0" style="border: 1px solid #5078B3;"
                                                            width="100%">
                                                            <tr>
                                                                <td colspan="4">
                                                                                ...
                                                                                <ContentTemplate>
                                                                                    <table style="width: 100%;border: 0px solid #86b2d1" align="center" cellpadding="3" cellspacing="1">
                                                                                        ...
                                                                                        <tr style="height: 30px">
                                                                                            ...
                                                                                            <td style="width: 25%">
                                                                                                <asp:TextBox ID="txtBillNoAdd" runat="server" Text='<%# Bind("BillNo") %>' Width="100%"
                                                                                                    SkinID="skinTxtBoxGrid"></asp:TextBox>
                                                                                            </td>
                                                                                            <td style="width: 25%" class="tblLeft">
                                                                                                Bill Amount:
                                                                                            ...
                                                                                            <td style="width: 25%">
                                                                                                <asp:TextBox ID="txtBillAmountAdd" runat="server" Text='<%# Bind("BillAmount") %>'
                                                                                        ...
                                                                                        <tr style="height: 30px">
                                                                                            ...
                                                                                            <td style="width: 25%">
                                                                                                <div style="border-width: 1px; border-color: #bce1fe; border-style: solid; width: 158px;
                                                                                                    font-family: 'Trebuchet MS';">
                                                                                                    <asp:DropDownList ID="ComboBox2Add" runat="server" SkinID="skinDdlBox" Width="100%" Height="29px" CssClass="drpDownListMedium" BackColor = "#90c9fc"
                                                                                        ...
                                                                                        <tr style="height: 30px">
                                                                                            ...
                                                                                            <td style="width: 25%;" class="RadioBk">
