...
public class ExcelHelper
{
    ...
    private static string getWorkbookTemplate()
    {
        ...
        sb.AppendFormat(@"   <Font ss:FontName=""Arial"" x:Family=""Swiss"" ss:Size=""10"" ss:Color=""#000000""/>{0}", Environment.NewLine);
        ...
        sb.AppendFormat(@"   <Interior ss:Color=""#A9A9F5"" ss:Pattern=""Solid"" />{0}", Environment.NewLine);
        sb.AppendFormat(@"   <Borders>{0}", Environment.NewLine);
    ...
    private static string getCell(Type type, object cellData)
    {
        ...
        if (type.Name.Contains("Int") || type.Name.Contains("Int32") || type.Name.Contains("Double") || type.Name.Contains("Decimal"))
        {
    ...
    private static string getWorksheets(DataSet source)
    {
        ...
        {
            sw.Write("<Worksheet ss:Name=\"Sheet1\">\r\n<Table><Column ss:Width=\"50\"/><Column ss:Width=\"50\"/><Column ss:Width=\"30\"/><Column ss:Width=\"90\"/>\r\n<Row><Cell><Data ss:Type=\"String\"></Data></Cell></Row>\r\n</Table>\r\n</Worksheet>");
            return sw.ToString();
        }
            ...
            else
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    if ((i % rowLimit) == 0)
                    {
                        ...
                        sw.Write(string.Format("\r\n<Column ss:StyleID=\"s65\" ss:Width=\"60.50\" />"));
                        sw.Write(string.Format("\r\n<Column ss:StyleID=\"s65\" ss:Width=\"90.25\" />"));
                        sw.Write(string.Format("\r\n<Column ss:StyleID=\"s65\" ss:Width=\"70.00\" />"));
                        sw.Write(string.Format("\r\n<Column ss:StyleID=\"s65\" ss:Width=\"85.05\" />"));
                        sw.Write(string.Format("\r\n<Column ss:StyleID=\"s65\" ss:Width=\"85.00\" />"));
                        sw.Write(string.Format("\r\n<Column ss:StyleID=\"s65\" ss:Width=\"60.00\" />"));
                        sw.Write(string.Format("\r\n<Column ss:StyleID=\"s65\" ss:Width=\"85.00\" />"));
                        sw.Write(string.Format("\r\n<Column ss:StyleID=\"s65\" ss:Width=\"90.00\" />"));
                        sw.Write(string.Format("\r\n<Column ss:StyleID=\"s65\" ss:Width=\"85.00\" />"));
                        sw.Write(string.Format("\r\n<Column ss:StyleID=\"s65\" ss:Width=\"70.00\" />"));
                        sw.Write("\r\n<Row ss:Height=\"19.75\">");
