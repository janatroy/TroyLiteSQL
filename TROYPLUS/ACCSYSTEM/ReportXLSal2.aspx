<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportXLSal2.aspx.cs" Inherits="ReportXLSal2" %>
        ...
        <div id="SalesPanel" runat="server">
         ...
         <table width="600px">
            ...
            <div id="divPrint" style="font-family: 'Trebuchet MS'; font-size: 11px;">
                ...
                <table  border="0" style="font-family: Trebuchet MS; width:600px; font-size: 14px;">
                     <tr>
