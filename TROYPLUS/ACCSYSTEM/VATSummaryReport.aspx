<%@ Page Language="C#" MasterPageFile="~/PageMaster.master" AutoEventWireup="true"
    CodeFile="VATSummaryReport.aspx.cs" Inherits="VATSummaryReport" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cplhControlPanel" runat="Server">
    ...
    <table cellpadding="2" cellspacing="4" width="600px" border="0" style="border: 1px solid silver;
        ...
        <tr>
            <td colspan="4" style="background-image: url('App_Themes/DefaultTheme/Images/bgReportheader.jpg');
    ...
    <br />
    <div id="divPrint">
        <div id="dvVat" visible="false" style="font-family: 'Trebuchet MS'; font-size: 11px;"
            runat="Server">
            <table style="border: 1px solid black; font-size: 11px; background-color: Aliceblue"
                ...
                <tr>
                    <td colspan="3" align="right">
                        <a href="VATReport.aspx">VAT Detailed Report</a>
                    </td>
                </tr>
                <tr>
