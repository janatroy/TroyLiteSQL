<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductCommPurchaseBill.aspx.cs"
    Inherits="ProductCommPurchaseBill" EnableTheming="false" %>
...
<head id="Head1" runat="server">
    <title>Commission Purchase Bill</title>
    <base target="_self">
                ...
                <tr>
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional" >
                             <ContentTemplate>
                            <asp:DropDownList ID="ddDivsions" runat="server" BackColor="#90c9fc" style="border: 1px solid Blue" height="24px"
                                Width="100%" AppendDataBoundItems="True" AutoPostBack="True"
                                OnSelectedIndexChanged="ddDivsions_SelectedIndexChanged" Visible="False">
                
                                <asp:ListItem Selected="True" Value="1" style="background-color: #90c9fc">Purchase Bill</asp:ListItem>
                                <asp:ListItem  Value="2" style="background-color: #90c9fc">Sales Bill</asp:ListItem>
                            </asp:DropDownList>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="ddDivsions" EventName="SelectedIndexChanged" />
                            </Triggers>
                        </asp:UpdatePanel>
                    ...
                    <tr>
                        ...
                        <td width="55%" align="left">
                            <table width="100%" style="font-family: 'Trebuchet MS'; font-size: 11px;">
                                <tr>
                                    <td valign="top">
                                        <b>&nbsp;</b><asp:Label ID="lblHeader" Text="Commission - Purchase Bill" runat="server" Font-Bold="true"></asp:Label>
                                    </td>
                        ...
                        <td colspan="2" style="border-bottom: 1px solid black; border-top: 1px solid black;">
                            <wc:ReportGridView runat="server" BorderWidth="1" ID="gvGeneral" CssClass="left"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField ItemStyle-HorizontalAlign="Left"  ItemStyle-Width="410px" DataField="Particulars"
                                        HeaderText="PARTICULARS" HeaderStyle-HorizontalAlign="Left" />
                                    <asp:BoundField ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="40px" DataFormatString="{0:f2}"
                                        DataField="NetRate" HeaderText="NetRate" Visible="false" />
                                    <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="40px" DataField="Qty"
                                        HeaderText="Qty" />
                                    <asp:BoundField ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="40px" DataFormatString="{0:f2}"
                                        DataField="PurchaseRate" HeaderText="Rate" />
                                    <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="60px" DataField="Unit"
                                        Visible="false" HeaderText="" />
                                    <asp:BoundField ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="70px" DataFormatString="{0:f2}"
                            ...
                            <div id="Div1" runat="server" visible="false" align="center">
                                <table width="600px" border="0" cellpadding="2" cellspacing="0" style="font-family: 'Trebuchet MS';
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" width="189px">
                                            Freight
                                            <asp:Label ID="Label1" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                        <td width="1px">
                                            :
                                        </td>
                                        <td align="right" width="70px">
                                            <asp:Label ID="lblfght" CssClass="lblFont" Text="0" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div id="Div3" runat="server" align="center">
                                <table width="600px" border="0" cellpadding="2" cellspacing="0" style="font-family: 'Trebuchet MS';
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" width="189px">
                                            Commission Value&nbsp;<asp:Label ID="Label3" runat="server" CssClass="lblFont"></asp:Label>&nbsp;
                                            <asp:Label ID="Label4" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                        <td width="1px">
                                            :
                                        </td>
                                        <td align="right" width="70px">
                                            <asp:Label ID="lblcomm" CssClass="lblFont" Text="0" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
