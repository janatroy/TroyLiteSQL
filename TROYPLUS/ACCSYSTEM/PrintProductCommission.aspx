<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintProductCommission.aspx.cs"
    Inherits="PrintProductCommission" %>
...
<head id="Head1" runat="server">
    <title>Commission Sales Bill</title>
    <base target="_self">
                ...
                <td>
                    ...
                    <table width="600px" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                <asp:Label ID="lblDivisions" runat="server" Text=""></asp:Label>
                            </td>
                            <td style="width: 30%">
                                <div id="divDiv" runat="server" style="width: 158px; font-family: 'Trebuchet MS';">
                                    <asp:DropDownList ID="ddDivsions" runat="server" BackColor="#90c9fc" style="border: 1px solid Blue" height="24px"
                                        ...
                                        <asp:ListItem Selected="True" Value="1" style="background-color: #90c9fc">Sales Bill</asp:ListItem>
                                        <asp:ListItem Value="2" style="background-color: #90c9fc">Purchase Bill</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </td>
                        </tr>
                    ...
                    <table width="600px" cellpadding="2" cellspacing="2" align="center">
                        <tr>
                            <td colspan="2">
                                <asp:Button Text="Enter" ID="btnCopy" runat="server" OnClick="btnCopy_Click" Visible="False" />
                            </td>
                        </tr>
                    </table>
                </td>
                            ...
                            <td>
                                ...
                                <div id="dvTotal600" runat="server">
                                    ...
                                    <div id="dvDiscountTotal600" runat="server" visible="false" align="center">
                                        <table width="600px" border="0" cellpadding="2" cellspacing="0" style="font-family: 'Trebuchet MS';
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" width="70px">
                                                    <asp:Label ID="lblGrandDiscount600" Visible="false" CssClass="lblFont" Text="0" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div id="dvVatTotal600" runat="server" visible="false" align="center">
                                        <table width="600px" border="0" cellpadding="2" cellspacing="0" style="font-family: 'Trebuchet MS';
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="189px">
                                                     &nbsp;<asp:Label ID="lblVatDisplay600" runat="server" CssClass="lblFont"></asp:Label>&nbsp;
                                                ...
                                                <td align="right" width="70px">
                                                    <asp:Label ID="lblGrandVat600" CssClass="lblFont" runat="server" Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div id="dvCSTTotal600" runat="server" visible="false" align="center">
                                        <table width="600px" border="0" cellpadding="2" cellspacing="0" style="font-family: 'Trebuchet MS';
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="189px">
                                                     &nbsp;<asp:Label ID="lblCSTDisplay600" runat="server" CssClass="lblFont"></asp:Label>&nbsp;
                                                ...
                                                <td align="right" width="70px">
                                                    <asp:Label ID="lblGrandCst600" CssClass="lblFont" Text="0" runat="server" Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div id="Div3" runat="server" align="center" visible="false">
                                        <table width="600px" border="0" cellpadding="2" cellspacing="0" style="font-family: 'Trebuchet MS';
                                            font-size: 11px;">
                                            <tr>
                                                <td width="340px">
                                    ...
                                    <table width="600px" border="0" cellpadding="2" cellspacing="0" style="font-family: 'Trebuchet MS';
                                        ...
                                        <tr id="Div33" runat="server" align="center" visible="false">
                                            <td align="left" width="340px">
                                                <asp:Label ID="Label1" runat="server" CssClass="lblFont" />
                                            </td>
                                            <td align="left" width="189px">
                                                Purchase Value
                                            ...
                                            <td align="right" width="70px" style="border-bottom: 1px solid black;">
                                                <asp:Label ID="lblpur" CssClass="lblFont" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                <div style="text-align: left" align="center">
                                    <div id="paymode" runat="server" align="center">
                                    </div>
                                    <br />
                                    <div id="divMultiPayment" runat="server" style="text-align: right" align="center">
                                        <wc:ReportGridView ID="GrdViewReceipt" runat="server" CssClass="left" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ChequeNo" HeaderText="CHEQUE" HeaderStyle-Wrap="false" />
