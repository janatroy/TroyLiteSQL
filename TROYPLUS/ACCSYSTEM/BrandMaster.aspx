<%@ Page Language="C#" MasterPageFile="~/PageMaster.master" AutoEventWireup="true"
    CodeFile="BrandMaster.aspx.cs" Inherits="BrandMaster" Title="Inventory > BrandMaster" %>
                        ...
                        <div class="mainConBody">
                            <table style="width: 99.8%; margin: -2px 0px 0px 1px;" cellpadding="3" cellspacing="2" class="searchbg">
                                <tr style="height: 25px; vertical-align: middle">
                                    <td style="width: 2%;"></td>
                                    <td style="width: 18%; font-size: 22px; color: White;">Brand Master
                                    </td>
                                    <td style="width: 13%">
                                                ...
                                                <EditItemTemplate>
                                                    <div class="divArea">
                                                        <table cellpadding="1" cellspacing="1" style="border: 1px solid #86b2d1; width: 100%;">
                                                            <tr>
                                                                <td colspan="4" class="headerPopUp">Brand Master
                                                                </td>
                                                            </tr>
                                                            <tr style="height: 5px">
                                                            </tr>
                                                ...
                                                <table style="border-color: white">
                                                    <tr style="border-color: white">
                                                        ...
                                                        <td style="border-color: white">
                                                            <asp:DropDownList ID="ddlPageSelector" BackColor="#e7e7e7" runat="server" AutoPostBack="true" Width="65px" Style="border: 1px solid blue" Height="23px">
                                                            </asp:DropDownList>
                                                        </td>
