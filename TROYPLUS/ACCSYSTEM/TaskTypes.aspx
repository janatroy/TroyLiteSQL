            ...
            <table style="width: 100%">
                                        ...
                                        <td style="width: 20%" class="NewBox">
                                            <div style="width: 160px; font-family: 'Trebuchet MS';">
                                                <asp:DropDownList ID="ddCriteria" runat="server" Width="153px" Height="23px" BackColor="White" style="text-align:center;border:1px solid white">
                                                    ...
                                                    <asp:ListItem Value="TaskTypeName">Task Type Name</asp:ListItem>
                                    ...
                                    <table style="width: 100%;" align="center">
                                        <tr style="width: 100%">
                                            ...
                                            <asp:FormView ID="frmViewAdd" runat="server" Width="100%" DataSourceID="frmSource"
                                                DataKeyNames="Task_Type_Id" OnItemCommand="frmViewAdd_ItemCommand" DefaultMode="Edit"
                            ...
                            <asp:GridView ID="GrdViewLedger" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-CssClass="command" HeaderText="Delete" HeaderStyle-Width="50px" HeaderStyle-BorderColor="Gray"
                                        ...
                                        <ItemTemplate>
                                            <cc1:ConfirmButtonExtender ID="CnrfmDel" TargetControlID="lnkB" ConfirmText="Are you sure to Delete this Task Type?"
                                                runat="server">
                                            </cc1:ConfirmButtonExtender>
                                            <asp:ImageButton ID="lnkB" SkinID="delete" runat="Server" CommandName="Delete"></asp:ImageButton>
                                            <asp:ImageButton ID="lnkBDisabled" Enabled="false" SkinID="deleteDisable" runat="Server">
                                            </asp:ImageButton>
                                            <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("Task_Type_Id") %>' />
                                            <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Bind("Task_Type_Name") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <PagerTemplate>
                ...
                <tr style="width:100%;">
                    <td style="width: 918px" align="left">
                        <asp:ObjectDataSource ID="GridSource" runat="server" SelectMethod="ListTaskTypesInfo"
                            TypeName="BusinessLogic" DeleteMethod="DeleteTaskTypes" OnDeleting="GridSource_Deleting">
                            <DeleteParameters>
                                <asp:CookieParameter Name="connection" CookieName="Company" Type="String" />
                                <asp:Parameter Name="Task_Type_Id" Type="Int32" />
                        ...
                        <asp:ObjectDataSource ID="frmSource" runat="server" SelectMethod="GetTaskTypesInfoForId"
                            TypeName="BusinessLogic" OnUpdating="frmSource_Updating" OnInserting="frmSource_Inserting"
                            InsertMethod="InsertTaskTypesInfo" UpdateMethod="UpdateTaskTypesInfo">
                            <UpdateParameters>
                                <asp:CookieParameter Name="connection" CookieName="Company" Type="String" />
                                <asp:Parameter Name="Task_Type_Id" Type="Int32" />
                                <asp:Parameter Name="Task_Type_Name" Type="String" />
                                <asp:Parameter Name="Username" Type="String" />
                            </UpdateParameters>
                            <SelectParameters>
                                <asp:ControlParameter ControlID="GrdViewLedger" Name="Task_Type_Id" PropertyName="SelectedValue"
                                    Type="String" />
                                <asp:CookieParameter Name="connection" CookieName="Company" Type="String" />
                            </SelectParameters>
                            <InsertParameters>
