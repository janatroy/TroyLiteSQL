<%@ Page Language="C#" AutoEventWireup="true" Title="Human Resource > Employee Leave Approval" CodeFile="EmployeeLeaveApproval.aspx.cs" Inherits="EmployeeLeaveApproval" MasterPageFile="~/PageMaster.master" %>
                        ...
                        <div class="mainConBody">
                            <table style="width: 100%; margin: -1px 0px 0px 1px;" cellpadding="3" cellspacing="2" class="searchbg">
                                <tr style="height: 25px; vertical-align: middle">
                                    <td style="width: 2%"></td>
                                    <td style="width: 16%; font-size: 22px; color: #000000;">Leave Requests
                                    </td>
                                    <td style="width: 14%">
                                        ...
                                        <asp:GridView ID="grdViewLeaveSummary" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-CssClass="command" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" HeaderStyle-BorderColor="Gray"
                                                    HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnApproveLeave" runat="server" Text="Approve" CommandName="ApproveLeave" CausesValidation="false" CommandArgument='<%#Eval("LeaveId")%>' />
                                                ...
                                                <asp:TemplateField ItemStyle-CssClass="command" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" HeaderStyle-BorderColor="Gray"
                                                    HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnRejectLeave" runat="server" Text="Reject" CommandName="RejectLeave" CommandArgument='<%#Eval("LeaveId")%>' CausesValidation="false" />
                                                    ...
                                                    <tr>
                                                        <td colspan="4" class="headerPopUp">
                                                            <asp:Label ID="lblPopupTitle" runat="server"
                                                                TabIndex="1" Text="Approve\Reject Leave Request"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr style="height: 5px">
                                                        <asp:HiddenField ID="hdfLeaveId" runat="server" />
                                                        <asp:HiddenField ID="hdfEmpNo" runat="server" />
                                                        <asp:HiddenField ID="hdfLeaveRequestResponse" runat="server" />
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 30%">
                                                            ...
                                                            <asp:DropDownList ID="ddlLeaveType" runat="server" Width="100%" BackColor="#90c9fc" Style="border: 1px solid blue" Height="26px" CssClass="drpDownListMedium"
                                                                TabIndex="3" DataSourceID="dataSrcLeaveTypes" Enabled="false"
