            ...
            <td style="width: 100%">
                                                                    ...
                                                                    <ContentTemplate>
                                                                         <table style="width: 1000px;" align="center" cellpadding="2" cellspacing="2">
                                                                            ...
                                                                            <tr style="height: 2px">
                                                                             ...
                                                                             <tr>
                                                                                   <td style="width: 25%" class="ControlLabelproject1">
                                                                                         ...
                                                                                         <td style="width: 25%" class="ControlDrpBorder">
                                                                                             <asp:DropDownList ID="drpBranch" TabIndex="4" EnableTheming="False" AppendDataBoundItems="True" CssClass="drpDownListMedium" Enabled="false"
                ...
                <asp:GridView ID="GrdWME" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ProjectName" HeaderText="Project Name" HeaderStyle-Font-Bold="true"   ItemStyle-ForeColor="#0567AE" ItemStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Left"   HeaderStyle-BorderColor="Gray"/>               
