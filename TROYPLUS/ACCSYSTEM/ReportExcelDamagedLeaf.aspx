<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReportExcelDamagedLeaf.aspx.cs" Inherits="ReportExcelDamagedLeaf" Title="Damaged Leaf Page" %>
        ...
        <div>
            <table width="400px" style=" background-color:White; border:1px solid blue;">
                    ...
                    <td colspan="4">
                        <table style="width:100%">
                            <tr>
                                ...
                                <td  style="width:40%">
                                    <asp:Label ID="Label7" runat="server" Text="Damaged Leaf Details" Font-Bold="True" Font-Size="13" ForeColor="#0033CC"></asp:Label>
                                </td>
                                <td style="width:30%">
                ...
                <tr>
                    ...
                    <td style="width: 15%">
                        <asp:TextBox ID="txtSearch" style="border: 1px solid Blue" runat="server" SkinID="skinTxtBoxSearch"></asp:TextBox>
                    </td>
                    <td style="width: 20%">
                        <div style="width: 150px; font-family: 'Trebuchet MS';">
                            <asp:DropDownList ID="ddCriteria" runat="server" Width="157px" Height="23px" CssClass="drpDownListMedium" style="text-align:center;border:1px solid Blue ">
