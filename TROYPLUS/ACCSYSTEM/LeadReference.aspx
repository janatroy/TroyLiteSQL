                                    ...
                                    <div class="mainGridHold" id="searchGrid">
                                        <asp:GridView ID="GrdViewLedger" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField FooterStyle-Font-Bold="True" HeaderText="Name of Drop-down field" ItemStyle-Font-Size="15px" HeaderStyle-Height="20px" ItemStyle-HorizontalAlign="Left" ItemStyle-Height="30px" ItemStyle-Font-Bold="true" ItemStyle-ForeColor="#0567AE" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="Small" HeaderStyle-BorderColor="Gray" HeaderStyle-Width="690px">
                                                                                          <ItemTemplate>
                                                                                          <asp:label ID="typename" runat="server"  Text='<%# Eval("TypeName")%>'></asp:label>
                                                                                                                                                            </ItemTemplate>
                                                                                                                                                        </asp:TemplateField>
