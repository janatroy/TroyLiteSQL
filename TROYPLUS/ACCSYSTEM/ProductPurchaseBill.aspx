<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductPurchaseBill.aspx.cs"
    Inherits="ProductPurchaseBill" EnableTheming="false" %>
                            ...
                            <wc:ReportGridView runat="server" BorderWidth="1" ID="gvGeneral" CssClass="left"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField ItemStyle-HorizontalAlign="right" ItemStyle-Width="40px" DataFormatString="{0:f2}"
                                        DataField="PurchaseRate" HeaderText="Rate"  HeaderStyle-HorizontalAlign="Left"/>
                                    ...
                                    <asp:BoundField ItemStyle-HorizontalAlign="right" ItemStyle-Width="40px" DataFormatString="{0:f2}"
                                        DataField="NetRate" HeaderText="NetRate" Visible="false"  HeaderStyle-HorizontalAlign="Left"/>
                                    <asp:BoundField ItemStyle-HorizontalAlign="Left" ItemStyle-Width="40px" DataField="Qty"
                                        HeaderText="Qty"  HeaderStyle-HorizontalAlign="Left"/>
                                    <asp:BoundField ItemStyle-HorizontalAlign="Left" ItemStyle-Width="60px" DataField="Unit"
                                        Visible="false" HeaderText=""  HeaderStyle-HorizontalAlign="Left"/>
                                    <asp:BoundField ItemStyle-HorizontalAlign="right" ItemStyle-Width="70px" DataFormatString="{0:f2}"
                                        DataField="Amount" HeaderText="Amount"  HeaderStyle-HorizontalAlign="Left"/>
                                </Columns>
                                <PagerTemplate>
                                </PagerTemplate>
                                <PageFooterTemplate>
                            ...
                            <div id="Div1" runat="server" visible="false" align="center">
                                <table width="600px" border="0" cellpadding="2" cellspacing="0" style="font-family: 'Trebuchet MS';
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" width="70px">
                                            <asp:Label ID="Label2" CssClass="lblFont" Text="0" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div id="Div2" runat="server" visible="false" align="center">
                                <table width="600px" border="0" cellpadding="2" cellspacing="0" style="font-family: 'Trebuchet MS';
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" width="189px">
                                            Disc Amt (For 
                                            <asp:Label ID="Label3" runat="server" CssClass="lblFont"></asp:Label>
                                        </td>
                                        <td width="1px">
                                            :
                                        </td>
                                        <td align="right" width="70px">
                                            <asp:Label ID="Label4" CssClass="lblFont" Text="0" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
