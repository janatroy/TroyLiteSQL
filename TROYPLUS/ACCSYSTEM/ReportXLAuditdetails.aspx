<%@ Page Language="C#" AutoEventWireup="true" CodeFile=" ReportXLAuditdetails.aspx.cs" Inherits=" ReportXLAuditdetails" %>
...
<head id="Head1" runat="server">
    <title>Audit Details Report</title>
                            ...
                            <table style="width:460px; height: 100%">
                                ...
                                <tr>
                                    ...
                                    <td style="width:35%;" class="ControlTextBox3">
                                            <asp:TextBox ID="txtSrtDate" Enabled="false" runat="server"  AutoPostBack="True" BackColor = "#90c9fc" SkinID="skinTxtBoxGrid"
                                                Width="100px"
