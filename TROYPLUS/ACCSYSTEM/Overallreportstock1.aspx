<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Overallreportstock1.aspx.cs" Inherits="Overallreportstock1" %>
        ...
        <div style="text-align: center; min-height: 400px">
            ...
            <div align="center" id="div1" runat="server">
                ...
                <td colspan="4">
                    ...
                    <tr>
                        <td colspan="4" class="subHeadFont2">Stock Transaction summary Report
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                    ...
                    <table>
                        <tr>
                            ...
                            <td width="560px" align="center">
                                <h5 style="font-size:large" >Stock Transaction BranchWise Summary Report
                                <asp:Label ID="lblHeadDate" Font-Size="Large" runat="server"> </asp:Label></h5>
                            </td>
                            <td>
                                <h5 style="font-size:large" >FOR
                                <asp:Label ID="lblbranch" Font-Size="Large" runat="server"> </asp:Label></h5>
                            </td>
                        </tr>
                    </table>
                    <div>
